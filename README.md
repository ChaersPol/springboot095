...
## 本项目获取地址：https://www.bishecode.com/product/92/
...
图5-1 用户管理页面【管理员可以对用户信息进行添加，修改，删除，查询操作】
![alt text](images/image-4.png)

图5-2 商品类型管理页面【管理员可以对商品类型信息进行添加，修改，删除，查询操作】
![alt text](images/image-5.png)

图5-3 商品信息管理页面【管理员可以对商品信息进行添加，修改，删除，查询操作】
![alt text](images/image-6.png)

图5-4 订单管理页面【管理员可以查看已支付订单，可以对订单进行发货】
![alt text](images/image-7.png)

图5-5 商品信息页面【用户可以查看商品信息，可以购买和加入购物车，也可以评论和收藏】
